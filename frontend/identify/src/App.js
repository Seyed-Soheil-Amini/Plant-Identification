  ...
  const handleSubmit = async () => {
    ...
    await axios
      ...
      .catch((err) => {
        setIsWaiting(false);
        console.log(err);
        toast.error("مشکلی در شناسایی وجود دارد، لطفا مجددا تلاش کنید.");
      });
  };
        ...
        <div className="container text-center py-5">
          ...
          <nav aria-label="breadcrumb animated slideInDown">
            <ol className="breadcrumb justify-content-center mb-0">
              <li className="text-light">سریع\ &nbsp;</li>
              <li className="text-light">قابل اعتماد\ &nbsp;</li>
      ...
      <div className="container-fluid flex-row md:flex md:flex-col justify-content-between">
        <div className="w-auto md:w-2/3 flex justify-end mx-auto">
          <div className="flex flex-col wow fadeInUp">
            ...
            <p className="mb-4 md:px-5 text-xs md:text-sm">
              <ol className="fw-medium list-decimal space-y-2 space-overflow-y-auto">
                <li>
                  ابتدا فایل خود را انتخاب کرده و سپس روی دکمه آپلود کلیک کنید{" "}
                </li>
                <li>
                  یک عکس را انتخاب کنید. روی عکسی که می‌خواهید در وب‌سایت آپلود
                  شود کلیک کنید یا ضربه بزنید.{" "}
                  <ul className="list-disc pr-5">
                    <li>
                      اگر می‌خواهید چند عکس را همزمان روی دسک‌تاپ آپلود کنید،
                      Ctrl (ویندوز) یا ⌘ Command (Mac) را نگه دارید و روی هر
                      عکسی که می‌خواهید آپلود کنید کلیک کنید.
                    </li>
                  </ul>
                </li>
                <li>
                  انتخاب خود را تایید کنید روی Open (رومیزی) کلیک کنید یا دو بار
                  روی Next (موبایل) ضربه بزنید.{" "}
                </li>
                <li>
                  عکس(ها) را آپلود کنید. روی آپلود عکس (یا آپلود چند عکس) در سمت
                  راست پایین صفحه کلیک کنید و سپس در صورت درخواست روی آپلود کلیک
                  کنید (ویندوز)، یا روی ارسال در گوشه سمت راست بالای صفحه
                  (موبایل) ضربه بزنید. عکس(های) انتخابی شما در وب سایت آپلود
                  خواهد شد.
                </li>
              </ol>
            </p>
            ...
            >
              ...
              <div>
                <span className="font-medium">
                  اطمینان حاصل کنید که این الزامات برآورده شده است:
                </span>
                <ul className="mt-1.5 list-disc list-inside text-xs md:text-sm">
                  <li>
                    تصویری که آپلود می کنید برای تشخیص بهتر باید عمودی باشد
                  </li>
                  <li>شفافیت عکس</li>
                  <li>از گرفتن عکس در حین حرکت خودداری کنید.</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        {!(
          ...
          >
            {isWaiting ? (
              ...
              <FaSearch className="flex items-center ml-2 my-auto" />
            )}
            {isWaiting ? "در حال شناسایی..." : "شناسایی"}
          </button>
        )}
      </div>
      <hr className="my-4 mx-3 border-4 border-green-700 rounded-5" />
