  ...
  , function (t, e, n) {
    ...
    window.tram = function (t) {
      ...
      var N = e.frame = function () {
        ...
        , M = l(function (e) {
          ...
          function h(t, e, i) {
            ...
            for (o in t)
              s = t[o],
                o in Y ? (l.transform || (l.transform = {}),
      ...
      S.transform && (K.transform = [W],
        ...
        S.transform && S.backface && (Y.z = [x, "translateZ"],
          Y.rotateZ = [k],
          Y.scaleZ = [g],
          Y.perspective = [y]);
      var Q = /ms/
  ...
  */
  ...
  , function (t, e, n) {
    ...
    i.define("dropdown", t.exports = function (t, e) {
      var n, u, c = e.debounce, l = {}, d = i.env(), f = !1, h = i.env.touch, p = ".w-dropdown", v = "w--open", m = r.triggers, w = 900, g = "focusout" + p, b = "keydown" + p, y = "mouseenter" + p, x = "mousemove" + p, k = "mouseleave" + p, E = (h ? "click" : "mouseup") + p, _ = "w-close" + p, O = "setting" + p, A = t(document);
      function T() {
        n = d && i.env("design"),
          (u = A.find(p)).each(C)
      }
        ...
        f || (f = "w-dropdown-toggle-" + e),
          ...
          l.links.each(function (t, e) {
            e.hasAttribute("tabindex") || e.setAttribute("tabindex", "0"),
              s.test(e.hash) && e.addEventListener("click", I.bind(null, l))
          }),
          l.el.off(p),
          l.toggle.off(p),
          l.nav && l.nav.off(p);
        ...
        r.done = a.find("> .w-form-done"),
          ...
          r.fileUploads.each(function (e) {
            !function (e, n) {
              ...
              if (d.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"),
